...
const float waveLength = 4.0f * PI; // Adjust the wavelength of the sine wave
const float amplitude = 0.5f;
int numPointsToDraw = 0; // Number of points to draw in each frame
int maxNumPoints = 100; // Maximum number of points to draw
...
void update(int value) {
    ...
    glutTimerFunc(10, update, 0); // Call update function every 16 milliseconds (60 FPS)
}
