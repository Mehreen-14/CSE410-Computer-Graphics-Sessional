...
void handleCollisions(int plane) {
    ...
    //for (int i = 0; i < sizeof(planeNormals) / sizeof(planeNormals[0]); ++i) {
        
            //printf("coll");
            // Collision detected with the i-th plane
            // Update the ball direction using reflection formula
            //printf("Colllided");
            ...
            if((a.x>0 && a.y>0 )){
               ...
               // ball_turn = (pi/2) - ball_turn;
                ...
                ball_turn = -180 + (atan(a.y/a.x)*180/pi);
            }
